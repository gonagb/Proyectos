  ...
  <main>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate method="post" action="procesa.php">
          ...
          <div class="row g-3">
            ...
            <?php
                ...
                while ($fila = $resultado->fetch_assoc()){
                    echo'
                       <div class="col-12">
                          <label for="address2" style="text-transform:capitalize;" class="form-label">'.$fila['Field'].'<span class="text-muted">(Optional)</span></label>';
