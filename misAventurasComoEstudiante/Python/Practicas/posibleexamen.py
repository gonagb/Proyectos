...
def apuesta(casilla):
    ...
    for i in datos:
     ...
     #Si el año consultado coincide con el año de la bbdd, saca el máximo y el mínimo    
        if anioInput == anioBd[2] and mesInput == mesBd[1]: 
...
#Calculo el promedio y hago un redondeo natural
    ...
    if casilla <= 5:
        ...
        print("El valor de la casilla ",casilla, "para el año ",anioInput, " y el mes ",mesInput," al que tienes que jugar es:" ,redondeomedia,"\n")
        ...
        print("El valor de la estrella ",contador, "para el año ",anioInput, " y el mes ",mesInput, "al que tienes que jugar es:" ,redondeomedia,"\n")
        
#input para introducir el año que queremos buscar        
print("Dime el año concreto de tu búsqueda")
anioInput = input()
print("Dime el mesconcreto de tu búsqueda")
mesInput = input()
