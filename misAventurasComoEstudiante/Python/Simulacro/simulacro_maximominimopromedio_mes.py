...
#Calculo el promedio y hago un redondeo natural
    ...
    if casilla <= 5:
        ...
        print("El valor de la casilla ",casilla, "para el mes ",mesInput, "al que tienes que jugar es:" ,redondeomedia,"\n")
        ...
        print("El valor de la estrella ",contador, "para el mes ",mesInput, "al que tienes que jugar es:" ,redondeomedia,"\n")
        
#input para introducir el año que queremos buscar        
print("Dime el mes concreto de tu búsqueda, en formato de dos digitos numéricos")
mesInput = input()
