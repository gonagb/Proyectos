...
def calcula(casilla):
  ...
  print("El número de la casilla",casilla," que más se repite en el mes",mesInput,"es: ",maximo,"\n")
  
#input para introducir el año que queremos buscar        
print("Dime el mes concreto de tu búsqueda")
mesInput = input()
...
def estrella(casilla):
  ...
  print("El número de la estrella",contador," que más se repite en el mes",mesInput,"es: ",maximo,"\n")
